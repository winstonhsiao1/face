...
#获取外接摄像头
eye = cv2.imread("E:/eye.jpg")
#读取眼睛区域替换的图片
mouth = cv2.imread("E:/mouth.jpg")
#读取嘴巴区域替换的图片
...
classifier_face = cv2.CascadeClassifier("E:\haarcascades/haarcascade_frontalface_alt.xml")
#定义分类器（人脸识别）
classifier_eye = cv2.CascadeClassifier("E:\haarcascades/haarcascade_eye.xml")
#定义分类器（人眼识别）
classifier_mouth=cv2.CascadeClassifier("E:\haarcascades/haarcascade_mcs_mouth.xml")
#定义分类器（嘴巴识别）
while (True):
